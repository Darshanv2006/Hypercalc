...
export default function CSPage() {
  return (
    <div className="p-4 sm:p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-text-primary mb-2">Computer Science</h1>
            ...
            >
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 rounded-lg bg-cs/10 flex items-center justify-center">
                    <Icon className="w-6 h-6 text-cs" />
                  </div>
                </div>
                <div className="flex-1 min-w-0">
                  <h3 className="text-lg font-semibold text-text-primary group-hover:text-cs transition-colors">
                    {calc.name}
                  </h3>
      ...
      <DomainFormulas domain="cs" accentClass="text-cs" />
    </div>
  );
}