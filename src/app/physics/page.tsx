...
const calculators = [
  {
    id: 'kinematics',
    name: 'Kinematics',
    description: 'Solve SUVAT equations',
    icon: Atom,
  },
  {
    id: 'projectile-motion',
    name: 'Projectile Motion',
    description: 'Calculate trajectory with graphs',
    icon: Atom,
  },
...
export default function PhysicsPage() {
  return (
    <div className="p-4 sm:p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-text-primary mb-2">Physics</h1>
              ...
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 rounded-lg bg-physics/10 flex items-center justify-center">
                    <Icon className="w-6 h-6 text-physics" />
                  </div>
                </div>
                <div className="flex-1 min-w-0">
                  <h3 className="text-lg font-semibold text-text-primary group-hover:text-physics transition-colors">
                    {calc.name}
                  </h3>
      ...
      <DomainFormulas domain="physics" accentClass="text-physics" />
    </div>
  );
}